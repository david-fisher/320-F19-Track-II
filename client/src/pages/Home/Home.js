    ...
    this.state = {
      heatMapData: {
        positions: [
          ...
          { lat: 42.253517, lng: -72.3588, weight: 1 }
        ],
        options: {
          radius: 80,
          opacity: 0.5
      ...
      <div>
        <div className="jumb">
          <Container class="container">
            <Jumbotron>
              ...
              <p>We strive to help end world hunger, one apple at a time.</p>
            </Jumbotron>
          </Container>
        </div>
        <Container>
        ...
        <Container className="textPadding">
          ...
          <p className="lead paragraph">
            ...
            analyze here at Orchard Watch. You can zoom in and scroll around to
            look closely at where our sensors are placed within the orchard. To
            change which type of data is being displayed, use the drop down menu
            above the map. Our sensors collect data on temperature, humidity,
            solar radiation, soil moisture, leaf wetness, rainfall, and wind
            speed. Areas with high values or intensity red or orange, with
            values decreasing as the colors change to yellow, green, and
            eventually to a clear overlay.
          </p>
        </Container>
      </div>
    );
